    ...
    >
      ...
      <g className="animate-wiggle3-left-right">
        ...
        <path
          ...
          fill="#4a3b32"
        />
        <circle cx="553.89292" cy="535.27109" r="8.23444" fill="#e6a99a" />
        <path
        ...
        <polygon
          ...
          fill="#4a3b32"
        />
        <rect x="481.59087" y="593.4507" width="123" height="64.09859" fill="#fdfbf7" />
        <path
        ...
        <polygon
          ...
          fill="#4a3b32"
        />
        <rect x="478.09087" y="484" width="2" height="98" fill="#4a3b32" />
        <rect x="606.09087" y="484" width="2" height="98" fill="#4a3b32" />
        <path
        ...
        <rect
          ...
          fill="#4a3b32"
        />
        <line x1="481.59087" y1="616.29921" x2="518.26494" y2="579.62514" fill="#fdfbf7" />
        <rect
          x="641.2089"
          y="717.68761"
          width="51.86514"
          ...
          fill="#4a3b32"
        />
        <line x1="481.59087" y1="636.33071" x2="536.11449" y2="579" fill="#fdfbf7" />
        <rect
          x="636.50738"
          y="727.39076"
          width="79.1178"
          ...
          fill="#4a3b32"
        />
        <rect x="466.09087" y="579" width="150" height="18" fill="#fdfbf7" />
        <path
        ...
        <path
          ...
          fill="#4a3b32"
        />
        <foreignObject x="410" y="115" width="270" height="230">
          <div className="rounded-2xl bg-[#fdfbf7]/95 border-2 border-[#8c6d58]/30 text-[#36271c] shadow-2xl p-5 backdrop-blur-sm" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }}>
            <span className="text-xs uppercase tracking-widest font-bold text-[#8c6d58] mb-1">Your AI Travel Companion</span>
            <h1 className="text-3xl md:text-4xl font-extrabold text-center tracking-tight leading-none text-[#36271c]">
              <SparklesText sparklesCount={10} className="w-full text-[#c86d51] font-black tracking-tight"
                colors={{
                  first: "#c86d51",
                  second: "#d97724",
                }}
