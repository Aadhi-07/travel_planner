...
const TopPlacesToVisit = ({
  ...
  return (
    <SectionWrapper id="topplacestovisit">
      ...
      <div className="flex flex-col bg-card/50 border border-border/40 dark:bg-background rounded-md lg:flex-row">
                  ...
                  {topPlaces?.map((place, index) => (
                    <li
                      ...
                      className="p-5 dark:bg-muted bg-white font-bold cursor-pointer
                          ...
                          hover:ring-2  hover:ring-[#c86d51]/40  duration-500"
    ...
    <div className="flex flex-col gap-1 justify-center items-center h-full">
      {isMaps ? (
        <div className="flex gap-2 justify-center items-center">
          <Loading />
          <p className="font-bold text-[#c86d51]">Loading Maps</p>
        </div>
      ) : (
        <>
